...
public class XMLResultAggregator extends Task implements XMLConstants {
     ...
     * @throws  org.apache.tools.ant.BuildException  thrown if there is a serious error while writing
     *          the document.
     */
     ...
     * @throws java.io.IOException thrown if there is an error while writing the content.
     */
