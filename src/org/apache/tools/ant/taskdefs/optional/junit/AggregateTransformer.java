...
public class AggregateTransformer {
     ...
     * @throws org.apache.tools.ant.BuildException if the document cannot be parsed.
     */
    ...
    /**
     * transformation
     * @throws org.apache.tools.ant.BuildException exception if something goes wrong with the transformation.
     */
    ...
    protected Resource getStylesheet() {
        String xslname = "junit-frames-extend.xsl";
     ...
     * @throws java.io.IOException thrown if the requested stylesheet does
     * not exist.
     */
