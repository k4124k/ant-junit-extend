 ...
 * @since Ant 1.2
 *
 * @see org.apache.tools.ant.taskdefs.optional.junit.JUnitTest
 * @see org.apache.tools.ant.taskdefs.optional.junit.BatchTest
 */
public class JUnitTask extends Task {
     ...
     * @see org.apache.tools.ant.taskdefs.optional.junit.SummaryJUnitResultFormatter
     *
     * @since Ant 1.2
     */
     ...
     * Runs the testcase.
     *
     * @throws org.apache.tools.ant.BuildException in case of test failures or errors
     * @since Ant 1.2
     */
     ...
     * @throws org.apache.tools.ant.BuildException if <code>testName</code> is not a valid test name
     */
     ...
     * @throws org.apache.tools.ant.BuildException in case of error creating a temporary property file,
     ...
     * @exception java.io.IOException if the data cannot be read.
     *
     * @since Ant 1.6
     */
     ...
     * Execute inside VM.
     * @param arg one JUnitTest
     * @throws org.apache.tools.ant.BuildException under unspecified circumstances
     * @return the results
     */
     ...
     * @exception org.apache.tools.ant.BuildException if some of the tests matching the described
